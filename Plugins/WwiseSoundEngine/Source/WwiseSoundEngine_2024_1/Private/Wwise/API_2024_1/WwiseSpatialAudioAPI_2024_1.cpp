...
AKRESULT FWwiseSpatialAudioAPI_2024_1::SetMaxReflectionPaths(AkUInt32 in_maxNumberOfReflectionPaths)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SpatialAudio::SetMaximumReflectionPaths(in_maxNumberOfReflectionPaths);
}
